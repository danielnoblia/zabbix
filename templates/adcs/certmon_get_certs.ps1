...
$certcount = Get-IssuedRequest -CertificationAuthority $ca_hostname -Filter "NotAfter -ge $start", "CertificateTemplate -eq $template" |
...
{
  ('[' + (Get-IssuedRequest -CertificationAuthority $ca_hostname -Filter "NotAfter -ge $start", "CertificateTemplate -eq $template" |
    Group-Object -Property Request.RequesterName |
    ForEach-Object { $_.Group | Sort-Object NotAfter -Descending | Select-Object -First 1 } |
